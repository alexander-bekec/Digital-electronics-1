...
architecture Behavioral of door_lock_core is
    ...
    signal s_cnt : STD_LOGIC_VECTOR(11 - 1 downto 0);
    signal s_counter_wrong_attempts : STD_LOGIC_VECTOR(2 - 1 downto 0);
    ...
    constant c_TIME_PASSWORD_ENTRY : STD_LOGIC_VECTOR(11 - 1 downto 0) := b"000_0101_0000";
    constant c_TIME_DOOR_OPENED : STD_LOGIC_VECTOR(11 - 1 downto 0) := b"000_0000_1100";
    constant c_TIME_ALARM_ENGAGED : STD_LOGIC_VECTOR(11 - 1 downto 0) := b"100_1011_0000";
    constant c_TIME_PASSWORD_WRONG_WARNING : STD_LOGIC_VECTOR(11 - 1 downto 0) := b"000_0000_0100";
    constant c_ZERO : STD_LOGIC_VECTOR(11 - 1 downto 0) := b"000_0000_0000";
begin
